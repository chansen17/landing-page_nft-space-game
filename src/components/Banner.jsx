  ...
  return (
    <div data-aos-easing="ease-in-out" className="min-h-[70vh] relative py-12 md:py-24">
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-4 items-center md:gap-16 gap-24 px-5">
            <div data-aos="fade-right" data-aos-duration="500" className="col-span-2 space-y-4 max-w-3xl mx-auto text-center md:text-left">
                ...
                <p className="font-semibold text-xl md:text-2xl lg:text-3xl xl:text-4xl text-slate-200">Discover the universe of <span className="font-bold underline">NFTs</span>. Find your potential.</p>
            ...
            <div data-aos="fade-in" data-aos-duration="2000" className="col-span-2 relative grid place-items-center group">
